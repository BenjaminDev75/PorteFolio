...
const projectsData = [
  ...
  {
    id:9,
    title: "Application Web de Recherche de Facturation",
    description: "Logiciel Web destiné aux personnes qui s'occupe des facturation des agences métier au seins de l'entreprise, "+
        "avec la possibilité d'effectuer une recherche par Agence, Siret, n° de contrat, et nom de tiers"+
        "le tout developper avec Logiciel Magic XPA et AngularJS",
  ...
  },
  {
    id:10,
    title: "Snowly",
    description: "Application Web de reservation d'hebergement dans le cadre des PPE du BTS SIO option SLAM, "+
        "pour la société Neige & Soleil"+
  ...
  },
  {
    id:10,
    title: "Snowly",
    description: "Application Lourd d'administration de l'application Web Snowly dans le cadre des PPE du BTS SIO option SLAM, "+
        "pour la société Neige & Soleil"+
  ...
  },
  {
    id:11,
    title: "MySNCF",
    description: "Application Mobile pour une enquête de satisfaction client de la SNCF, "+
